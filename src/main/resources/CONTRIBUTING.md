...
existing [Issues](${project.issueManagement.url}) that might help you. In case
...
- To see if other users have experienced (and potentially already solved) the
  ...
  the [bug tracker](${project.issueManagement.url}?q=label%3Abug).
...
- Perform a [search](${project.issueManagement.url}) to see if the enhancement
...
as [GitHub issues](${project.issueManagement.url}).
...
- Commit message rules:
	- Commit messages of bugfixes **MUST** be start wird `fix: ISSUE_ID`
